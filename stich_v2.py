...
# Define the desired order of sides
sides_order = ['B', 'L', 'F', 'R']

# Define the image names
image_names = ["WE0NXXN0"]  # Example image name

# Call the function to stitch final images
stitch_final_images(image_names, sides_order)
